      ...
      rl.question('Which meal is your favourite ', (answer4) => {
        rl.question('Which sport is your absolute favourite ', (answer5) => {
          rl.question('What is your superpower? In a few words, tell us what you are amazing at! ', (answer6) => {
            console.log(`Your name is ${answer1}, and your favourite activity to do is ${answer2}, while listening to ${answer3}.\n Your fave meal is ${answer4}.\n Your favourite sport is ${answer5}.\n Your secret super power is to ${answer6}`);
